...
if not final_results.empty:
    ...
    correspondence_output_dir = "/Users/lamprosandroutsos/Documents/Thesis/Thesis_Food/clustering_comparison_results/correspondence_tables/"
    import os
    ...
    for name, corr in all_correspondences.items():
        if corr is not None and isinstance(corr, pd.DataFrame):
            try:
                corr_filename = f"correspondence_{name}_flavordb_VS_additionEmbed_683_fixCupuaDragee.csv"
