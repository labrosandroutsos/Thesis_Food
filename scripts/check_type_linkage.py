...
linkage_single = linkage(df_foodb, method='single', metric='jaccard')
linkage_complete = linkage(df_foodb, method='complete', metric='jaccard')
linkage_average = linkage(df_foodb, method='average', metric='jaccard')
...
best_clusters = fcluster(linkage_single, criterion='maxclust', t=30)
...
output_path = '/Users/lamprosandroutsos/Documents/Thesis/Thesis_Food/compounds_presence/single_correct_linkage_clusters_distance_30_clusters_jaccard.txt'
